...
public class ConventionStatsDomaineManagerImpl implements ConventionStatsDomaineManager {
	/**
	 * liste clef, valeur des domaines services pour les conventions
	 */
	private transient Map<String, ConventionStatsDomaineService> cvtsDomaineServices;

	@SuppressWarnings("unused")
	private transient CoreMessages coreMessages;
	 ...
	 */
	public void setCvtsDomaineServices(Map<String, ConventionStatsDomaineService> cvtsDomaineServices) {
