...
INSERT INTO `LangueConvention` (`codeLangueConvention`, `libelleLangueConvention`, `temEnServLangue`) VALUES ('fo', 'Francophone (stage étranger dans un pays francophone)', 'N');
...
INSERT INTO `UniteGratification` (`idUniteGratification`, `libelleUniteGratification`, `temEnServGrat`) VALUES (2, 'Brut', 'N');
