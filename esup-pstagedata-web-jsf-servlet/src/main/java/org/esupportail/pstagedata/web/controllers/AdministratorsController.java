...
public class AdministratorsController extends AbstractContextAwareController {
	...
	/**
	 * @see org.esupportail.pstagedata.web.controllers.AbstractContextAwareController#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.pstagedata.web.controllers.AbstractContextAwareController#reset()
	 */
	@Override
	public void reset() {
		super.reset();
