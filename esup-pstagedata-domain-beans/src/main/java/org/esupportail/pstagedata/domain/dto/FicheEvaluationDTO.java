 ...
 *
 */
public class FicheEvaluationDTO extends ObjetMetiersDTO implements Serializable{
	/**
	 * 
	 */
	 ...
	 * Constructeur
	 */
	public FicheEvaluationDTO(FicheEvaluation fe){
		super(fe);
		if(fe!=null){
			this.idFicheEvaluation = fe.getIdFicheEvaluation();
			this.idCentreGestion = fe.getIdCentreGestion();
			this.validationEtudiant = fe.isValidationEtudiant();
			this.validationEnseignant = fe.isValidationEnseignant();
			this.validationEntreprise = fe.isValidationEntreprise();
			this.questionEnt1 = fe.isQuestionEnt1();
			this.questionEnt2 = fe.isQuestionEnt2();
			this.questionEnt3 = fe.isQuestionEnt3();
			this.questionEnt4 = fe.isQuestionEnt4();
			this.questionEnt5 = fe.isQuestionEnt5();
			this.questionEnt6 = fe.isQuestionEnt6();
			this.questionEnt7 = fe.isQuestionEnt7();
			this.questionEnt8 = fe.isQuestionEnt8();
			this.questionEnt9 = fe.isQuestionEnt9();
			this.questionEnt10 = fe.isQuestionEnt10();
			this.questionEnt11 = fe.isQuestionEnt11();
			this.questionEnt12 = fe.isQuestionEnt12();
			this.questionEnt13 = fe.isQuestionEnt13();
			this.questionEnt14 = fe.isQuestionEnt14();
			this.questionEnt15 = fe.isQuestionEnt15();
			this.questionEnt16 = fe.isQuestionEnt16();
			this.questionEnt17 = fe.isQuestionEnt17();
			this.questionEnt18 = fe.isQuestionEnt18();
			this.questionEnt19 = fe.isQuestionEnt19();
			this.questionEtuI1 = fe.isQuestionEtuI1();
			this.questionEtuI2 = fe.isQuestionEtuI2();
			this.questionEtuI3 = fe.isQuestionEtuI3();
			this.questionEtuI4 = fe.isQuestionEtuI4();
			this.questionEtuI5 = fe.isQuestionEtuI5();
			this.questionEtuI6 = fe.isQuestionEtuI6();
			this.questionEtuI7 = fe.isQuestionEtuI7();
			this.questionEtuI8 = fe.isQuestionEtuI8();
			this.questionEtuII1 = fe.isQuestionEtuII1();
			this.questionEtuII2 = fe.isQuestionEtuII2();
			this.questionEtuII3 = fe.isQuestionEtuII3();
			this.questionEtuII4 = fe.isQuestionEtuII4();
			this.questionEtuII5 = fe.isQuestionEtuII5();
			this.questionEtuII6 = fe.isQuestionEtuII6();
			this.questionEtuIII1 = fe.isQuestionEtuIII1();
			this.questionEtuIII2 = fe.isQuestionEtuIII2();
			this.questionEtuIII3 = fe.isQuestionEtuIII3();
			this.questionEtuIII4 = fe.isQuestionEtuIII4();
			this.questionEtuIII5 = fe.isQuestionEtuIII5();
			this.questionEtuIII6 = fe.isQuestionEtuIII6();
			this.questionEtuIII7 = fe.isQuestionEtuIII7();
			this.questionEtuIII8 = fe.isQuestionEtuIII8();
			this.questionEtuIII9 = fe.isQuestionEtuIII9();
			this.questionEtuIII10 = fe.isQuestionEtuIII10();
			this.questionEtuIII11 = fe.isQuestionEtuIII11();
			this.questionEtuIII12 = fe.isQuestionEtuIII12();
			this.questionEtuIII13 = fe.isQuestionEtuIII13();
			this.questionEtuIII14 = fe.isQuestionEtuIII14();
			this.questionEtuIII15 = fe.isQuestionEtuIII15();
			this.questionEtuIII16 = fe.isQuestionEtuIII16();
			this.questionEnsI1 = fe.isQuestionEnsI1();
			this.questionEnsI2 = fe.isQuestionEnsI2();
			this.questionEnsI3 = fe.isQuestionEnsI3();
			this.questionEnsII1 = fe.isQuestionEnsII1();
			this.questionEnsII2 = fe.isQuestionEnsII2();
			this.questionEnsII3 = fe.isQuestionEnsII3();
			this.questionEnsII4 = fe.isQuestionEnsII4();
			this.questionEnsII5 = fe.isQuestionEnsII5();
			this.questionEnsII6 = fe.isQuestionEnsII6();
			this.questionEnsII7 = fe.isQuestionEnsII7();
			this.questionEnsII8 = fe.isQuestionEnsII8();
			this.questionEnsII9 = fe.isQuestionEnsII9();
			this.questionEnsII10 = fe.isQuestionEnsII10();
			this.questionEnsII11 = fe.isQuestionEnsII11();
		}
	}
	...
	public String toString(){
		...
		"questionEnt1 : "+questionEnt1+", "+
		"questionEnt2 : "+questionEnt2+", "+
		"questionEnt3 : "+questionEnt3+", "+
		"questionEnt4 : "+questionEnt4+", "+
		"questionEnt5 : "+questionEnt5+", "+
		"questionEnt6 : "+questionEnt6+", "+
		"questionEnt7 : "+questionEnt7+", "+
		"questionEnt8 : "+questionEnt8+", "+
		"questionEnt9 : "+questionEnt9+", "+
		"questionEnt10 : "+questionEnt10+", "+
		"questionEnt11 : "+questionEnt11+", "+
		"questionEnt12 : "+questionEnt12+", "+
		"questionEnt13 : "+questionEnt13+", "+
		"questionEnt14 : "+questionEnt14+", "+
		"questionEnt15 : "+questionEnt15+", "+
		"questionEnt16 : "+questionEnt16+", "+
		"questionEnt17 : "+questionEnt17+", "+
		"questionEnt18 : "+questionEnt18+", "+
		"questionEnt19 : "+questionEnt19+", "+
		"questionEtuI1 : "+questionEtuI1+", "+
		"questionEtuI2 : "+questionEtuI2+", "+
		"questionEtuI3 : "+questionEtuI3+", "+
		"questionEtuI4 : "+questionEtuI4+", "+
		"questionEtuI5 : "+questionEtuI5+", "+
		"questionEtuI6 : "+questionEtuI6+", "+
		"questionEtuI7 : "+questionEtuI7+", "+
		"questionEtuI8 : "+questionEtuI8+", "+
		"questionEtuII1 : "+questionEtuII1+", "+
		"questionEtuII2 : "+questionEtuII2+", "+
		"questionEtuII3 : "+questionEtuII3+", "+
		"questionEtuII4 : "+questionEtuII4+", "+
		"questionEtuII5 : "+questionEtuII5+", "+
		"questionEtuII6 : "+questionEtuII6+", "+
		"questionEtuIII1 : "+questionEtuIII1+", "+
		"questionEtuIII2 : "+questionEtuIII2+", "+
		"questionEtuIII3 : "+questionEtuIII3+", "+
		"questionEtuIII4 : "+questionEtuIII4+", "+
		"questionEtuIII5 : "+questionEtuIII5+", "+
		"questionEtuIII6 : "+questionEtuIII6+", "+
		"questionEtuIII7 : "+questionEtuIII7+", "+
		"questionEtuIII8 : "+questionEtuIII8+", "+
		"questionEtuIII9 : "+questionEtuIII9+", "+
		"questionEtuIII10 : "+questionEtuIII10+", "+
		"questionEtuIII11 : "+questionEtuIII11+", "+
		"questionEtuIII12 : "+questionEtuIII12+", "+
		"questionEtuIII13 : "+questionEtuIII13+", "+
		"questionEtuIII14 : "+questionEtuIII14+", "+
		"questionEtuIII15 : "+questionEtuIII15+", "+
		"questionEtuIII16 : "+questionEtuIII16+", "+
		"questionEnsI1 : "+questionEnsI1+", "+
		"questionEnsI2 : "+questionEnsI2+", "+
		"questionEnsI3 : "+questionEnsI3+", "+
		"questionEnsII1 : "+questionEnsII1+", "+
		"questionEnsII2 : "+questionEnsII2+", "+
		"questionEnsII3 : "+questionEnsII3+", "+
		"questionEnsII4 : "+questionEnsII4+", "+
		"questionEnsII5 : "+questionEnsII5+", "+
		"questionEnsII6 : "+questionEnsII6+", "+
		"questionEnsII7 : "+questionEnsII7+", "+
		"questionEnsII8 : "+questionEnsII8+", "+
		"questionEnsII9 : "+questionEnsII9+", "+
		"questionEnsII10 : "+questionEnsII10+", "+
		"questionEnsII11 : "+questionEnsII11+", "+		
		", "+super.toString();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FicheEvaluationDTO other = (FicheEvaluationDTO) obj;
