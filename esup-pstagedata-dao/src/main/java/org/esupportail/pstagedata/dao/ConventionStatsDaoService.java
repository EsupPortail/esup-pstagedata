...
public interface ConventionStatsDaoService {
	...
	/*Ajout duree*/
	public List<StatisticItem> getNumberOfConventionsByNbWeeks(Integer idCentreGestion, String annee)throws DataAccessDaoException;
	public List<StatisticItem> getNumberOfConventionsByDepartmentAndNbWeeks(Integer idCentreGestion, String annee)throws DataAccessDaoException;
	public List<StatisticItem> getNumberOfConventionsByStudyAndNbWeeks(Integer idCentreGestion, String annee)throws DataAccessDaoException;
	public List<StatisticItem> getNumberOfConventionsByStepAndNbWeeks(Integer idCentreGestion, String annee)throws DataAccessDaoException;
